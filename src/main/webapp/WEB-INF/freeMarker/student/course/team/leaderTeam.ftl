            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    ...
                    <form>
                        ...
                        <input type="text" class="form-control1 form-control-solid " name="info" placeholder="搜索成员" style="width: 60%;margin-left: 2%">
                        <input type="submit" class="formSubmit" value="">
                        <button type="submit" class="am-btn am-btn-success" style="height: 34px;padding-top:6px;width: 25%;margin-left: 2rem;margin-top: -5.5rem;border-radius: 0.5rem">添加</button>
                        ...
                        <button type="submit" class="am-btn am-btn-success" style="border-radius: 0.5rem;width: 35%;margin-top: 2rem;padding-left: 1rem;margin-left: 1rem">解散小组</button>
                        <button type="submit" class="am-btn am-btn-success" style="margin-left:4rem;width: 35%;margin-top: 2rem;padding-left: 1rem;border-radius: 0.5rem">保存</button>
                    </form>
                </#if>
                </div>
            </div>
