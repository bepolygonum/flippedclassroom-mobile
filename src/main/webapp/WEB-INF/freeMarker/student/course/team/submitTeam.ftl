        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <form>
                        <span class="myLabel">小组名:</span><input class="myLabel"  type="text" placeholder="请填写小组名称" style="margin-top: -0.4rem;margin-left: 3rem" ><br>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table class="am-table am-table-striped am-table-hover table-main">
                                        <tr>
                                            <td><input type="checkbox" name="radio1" value="张三丰" class="data-am-ucheck"  style="margin-left: 1rem"></td>
                                            <td>24320162202001</td>
                                            <td>张三丰</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="radio1" value="张三" class="data-am-ucheck"  style="margin-left: 1rem"></td>
                                            <td>24320162202001</td>
                                            <td>张三</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="radio1" value="李四" class="data-am-ucheck"  style="margin-left: 1rem"></td>
                                            <td>24320162202001</td>
                                            <td>李四</td>
                                        </tr>
                                    </table>
                        ...
                        <button type="submit" class="am-btn am-btn-success" style="width: 100%;margin-top: 3rem">确认提交</button>
                    </form>
                </div>
            </div>
        </div>
